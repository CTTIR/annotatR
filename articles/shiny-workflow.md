...
#> out_dir: /tmp/RtmphG8awi/annotatR-example-session-2ed569e8a0c2  |  autosave: TRUE
```
...
#> 1     1 /tmp/RtmphG8awi/an… imag… compl… NA                0 NA      
#> 2     2 /tmp/RtmphG8awi/an… imag… pendi… NA                0 NA      
#> 3     3 /tmp/RtmphG8awi/an… imag… pendi… NA                0 NA

at_manifest(sess)
#> # A tibble: 3 × 9
#>     idx name     path              status n_layers n_rois tumour necrosis stroma
#>   <int> <chr>    <chr>             <chr>     <int>  <int>  <int>    <int>  <int>
#> 1     1 image_01 /tmp/RtmphG8awi/… compl…        0      0      0        0      0
#> 2     2 image_02 /tmp/RtmphG8awi/… pendi…        0      0      0        0      0
#> 3     3 image_03 /tmp/RtmphG8awi/… pendi…        0      0      0        0      0
```
