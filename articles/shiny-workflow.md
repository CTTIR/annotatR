...
#> out_dir: /tmp/RtmpSJpCsG/annotatR-example-session-2d803eba0a4f  |  autosave: TRUE
```
...
#> 1     1 /tmp/RtmpSJpCsG/an… imag… compl… NA                0 NA      
#> 2     2 /tmp/RtmpSJpCsG/an… imag… pendi… NA                0 NA      
#> 3     3 /tmp/RtmpSJpCsG/an… imag… pendi… NA                0 NA

at_manifest(sess)
#> # A tibble: 3 × 9
#>     idx name     path              status n_layers n_rois tumour necrosis stroma
#>   <int> <chr>    <chr>             <chr>     <int>  <int>  <int>    <int>  <int>
#> 1     1 image_01 /tmp/RtmpSJpCsG/… compl…        0      0      0        0      0
#> 2     2 image_02 /tmp/RtmpSJpCsG/… pendi…        0      0      0        0      0
#> 3     3 image_03 /tmp/RtmpSJpCsG/… pendi…        0      0      0        0      0
```
