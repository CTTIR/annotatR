...
#> out_dir: /tmp/Rtmps5pqui/annotatR-example-session-2e2e19bb4692  |  autosave: TRUE
```
...
#> 1     1 /tmp/Rtmps5pqui/an… imag… compl… NA                0 NA      
#> 2     2 /tmp/Rtmps5pqui/an… imag… pendi… NA                0 NA      
#> 3     3 /tmp/Rtmps5pqui/an… imag… pendi… NA                0 NA

at_manifest(sess)
#> # A tibble: 3 × 9
#>     idx name     path              status n_layers n_rois tumour necrosis stroma
#>   <int> <chr>    <chr>             <chr>     <int>  <int>  <int>    <int>  <int>
#> 1     1 image_01 /tmp/Rtmps5pqui/… compl…        0      0      0        0      0
#> 2     2 image_02 /tmp/Rtmps5pqui/… pendi…        0      0      0        0      0
#> 3     3 image_03 /tmp/Rtmps5pqui/… pendi…        0      0      0        0      0
```
