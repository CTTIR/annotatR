...
#> out_dir: /tmp/Rtmp43QctH/annotatR-example-session-2da260f1d6f5  |  autosave: TRUE
```
...
#> 1     1 /tmp/Rtmp43QctH/an… imag… compl… NA                0 NA      
#> 2     2 /tmp/Rtmp43QctH/an… imag… pendi… NA                0 NA      
#> 3     3 /tmp/Rtmp43QctH/an… imag… pendi… NA                0 NA

at_manifest(sess)
#> # A tibble: 3 × 9
#>     idx name     path              status n_layers n_rois tumour necrosis stroma
#>   <int> <chr>    <chr>             <chr>     <int>  <int>  <int>    <int>  <int>
#> 1     1 image_01 /tmp/Rtmp43QctH/… compl…        0      0      0        0      0
#> 2     2 image_02 /tmp/Rtmp43QctH/… pendi…        0      0      0        0      0
#> 3     3 image_03 /tmp/Rtmp43QctH/… pendi…        0      0      0        0      0
```
